...
print ("[Dongle] Converting to UFO")
main(("glyphs2ufo", "sources/Dongle.glyphs", "--write-public-skip-export-glyphs", "--propagate-anchors"))
...
def build(ufo:ufoLib2):
    ...
    family_name = source.info.familyName
...
for ufo in path.glob("*.ufo"):
    shutil.rmtree(ufo)
os.remove("sources/Dongle.designspace")